...
export default function LinkedSearchDatasetVarTable({linkedSearchPathList, searchTerm, kbUri, height, setDatasetUriCallBack}){
   ...
   [selectedDataHubBindings]
    ...
    return(
        <Card style={{overflow:"scroll", width:"100%", height:{height}}}>
            <Card.Header>
